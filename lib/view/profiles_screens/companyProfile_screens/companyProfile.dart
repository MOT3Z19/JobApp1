...
class _CopmanyProfileScreenState extends State<CopmanyProfileScreen> {
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text(
                                profileCompany.companyDescription ?? ''),
                          ),
                          SizedBox(height: height * .01),
                          Row(
                            children: [
                          ...
                          FutureBuilder<List<JobAdvertisement>?>(
                            future: _jobAdsController.getCompanyJobs(),
                            builder: (context, snapshot) {
  ...
  String calculateYearsOfExcellence(String establishmentDate) {
    ...
    DateFormat('yyyy-MM-dd').parse(establishmentDate);
    int yearsOfExcellence = DateTime
        .now()
        .year - establishedDate.year;
    if (DateTime
        .now()
        .month < establishedDate.month ||
        (DateTime
            .now()
            .month == establishedDate.month &&
            DateTime
                .now()
                .day < establishedDate.day)) {
      yearsOfExcellence--;
    }
